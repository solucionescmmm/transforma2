...
class updateObjetivos {
    ...
    async #validations() {
        ...
        let queryGetObjetivos = await getObjetivos({}, this.#objUser);
    ...
    async #updateObjetivos() {
        let dao = new classInterfaceDAOObjetivos();

        let query = await dao.updateObjetivos(this.#objData);
...
module.exports = updateObjetivos;
