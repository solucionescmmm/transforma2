...
class setAcompañamiento {
    ...
    async #setSesionAcompañamiento() {
        ...
        let newData = {
            ...
            intIdRuta: this.#objData?.objInfoRutaExs?.objRuta?.objInfoPrincipal?.intId || this.#objData?.intIdRuta || null,
            intIdFase: this.#objData?.objInfoRutaExs?.objFase?.intId || this.#objData?.intIdFase || null,
            intIdPaquete: this.#objData?.objNuevoServPaq?.objPaquete?.objInfoPrincipal?.intId || this.#objData?.intIdPaquete || null,
            intIdServicio: this.#objData?.objNuevoServPaq?.objServicio?.objInfoPrincipal?.intId || this.#objData?.objInfoRutaExs?.objServicio?.objServicio?.objInfoPrincipal?.intId || this.#objData?.intIdServicio || null,
