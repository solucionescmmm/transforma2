                    ...
                    for (let j = 0; j < arrFasesRutas.length; j++) {
                        ...
                        if (arrObjPaquetes?.length > 0) {
                            for (let k = 0; k < arrObjPaquetes.length; k++) {
                                ...
                                arrPaquetes.push({
                                    ...arrObjPaquetes[k],
                                    strResponsable: JSON.parse(arrObjPaquetes[k]?.strResponsables || null),
                        ...
                        if (arrObjServicios?.length > 0) {
                            for (let k = 0; k < arrObjServicios.length; k++) {
                                ...
                                arrServicios.push({
                                    ...
                                    strResponsable: JSON.parse(arrObjServicios[k]?.strResponsables || null),
                        ...
                        arrInfoFases[j] = {
                            ...
                            arrPaquetes,
                            arrServicios,
                            arrPorcentajes: arrFasesRutas[j].arrPorcentajes
                        };
                    }
