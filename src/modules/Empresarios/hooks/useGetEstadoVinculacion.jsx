 ...
 *
 */
const useGetEstadoVinculacion = ({ autoLoad = true } = {}) => {
    //===============================================================================================================================================
            ...
            return await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_EMPRESARIOS_GET_ESTADOVINCULACION}`,
                    headers: {
                        token,
                    },
                },
...
export default useGetEstadoVinculacion;