...
const useGetDiagnosticosCoco = ({ intIdIdea = null, intId = null, autoLoad = true } = {}) => {
    //===============================================================================================================================================
            ...
            return await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_DIAGNOSTICOS_GET_COCO}`,
                    headers: {
                        token,
                    },
                    params: {
...
export default useGetDiagnosticosCoco;
