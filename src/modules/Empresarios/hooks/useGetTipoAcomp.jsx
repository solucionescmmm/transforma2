 ...
 *
 */
const useGetTipoAcomp = ({ intIdIdea = null, autoLoad = true } = {}) => {
    //===============================================================================================================================================
            ...
            return await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_RUTAS_TIPO_ACOMPANIAMIENTO_GET}`,
                    headers: {
                        token,
                    },
                },
...
export default useGetTipoAcomp;
