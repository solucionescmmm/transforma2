...
const ModalActiveRuta = ({
            ...
            await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_RUTAS_ACTIVE}`,
                    data: {
                        intId: data.intId,
                    },
                    headers: {
    ...
    return (
        ...
        >
            ...
            <DialogTitle>{`¿Deseas activar la ruta seleccionada?`}</DialogTitle>

            <DialogContent>
                <DialogContentText>
                    El proceso activara la ruta y no podrá ser editada
                    nuevamente.
                </DialogContentText>
            </DialogContent>
...
export default ModalActiveRuta;
