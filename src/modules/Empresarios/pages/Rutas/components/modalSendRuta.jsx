...
const ModalSendRuta = ({ handleOpenDialog, open, intId, refresh, intIdIdea}) => {
    //===============================================================================================================================================
    //========================================== Context ============================================================================================
    //===============================================================================================================================================
            ...
            await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_RUTAS_SEND}`,
                    data: {
                        intId: data.intId,
                    },
                    headers: {
    ...
    return (
        ...
        >
            ...
            <DialogTitle>{`¿Deseas pasar a enviada la ruta seleccionada?`}</DialogTitle>

            <DialogContent>
                <DialogContentText>
                    El proceso pasara la ruta a enviada, lo cual no podrá ser
                    eliminada.
                </DialogContentText>
            </DialogContent>
