...
const ModalEditPorcentaje = ({
    ...
    useEffect(() => {
        if (values?.value) {
            setData({
                intPorcentaje: values ? values.value.intPorcentaje : "",
            });

            setIntValorPorc(values ? values.value.valorPorce : "");
...
export default ModalEditPorcentaje;
