...
// Componentes
import CUPersona from "./create&Edit";
...
const SearchEmpresario = ({ isEdit, intIdIdea, onChangeRoute, values }) => {
    ...
    const [bitMismaIdea, setBitMismaIdea] = useState(false);
                    ...
                    <Paper className={classes.paper}>
                        ...
                        >
                            ...
                            <Grid item xs={12}>
                                ...
                                {data && bitMismaIdea === true && !loadingGetData && (
                                    <Alert severity="warning">
                                        La persona buscada ya pertenece a esta idea
                                    </Alert>
                                )}
                            ...
                            {bitBuscar === true && bitMismaIdea === false ? (
                                <Grid item xs={12}>
                                    <Box
                                        sx={{
                                            display: "flex",
