...
const ModalState = ({ handleOpenDialog, open, values, refresh, intIdIdea}) => {
    //===============================================================================================================================================
    //========================================== Context ============================================================================================
    //===============================================================================================================================================
            ...
            await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_TAREAS_BIT}`,
                    data: {
                        intId: data.intId,
                        btFinalizada: !data.btFinalizada,
                    },
                    headers: {
                        token,
                    },
    ...
    useEffect(() => {
        if (values) {
            setData({
                intId: values.intId,
                btFinalizada: values.btFinalizada,
            });
        }
