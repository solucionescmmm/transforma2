                    ...
                    .then((res) => {
                        ...
                        if (res.data.data) {
                            ...
                            setData({
                                ...
                                dtFechaInicio: parseISO(data.dtFechaInicio),
            ...
            <DialogContent>
                ...
                {errorGetData.flag && (
                    <Alert severity="error">
                        Ha ocurrido un error al obtener los datos de la sesion
                        seleccionada, por favor escala al área de TI para más
                        información.
                    </Alert>
                )}
