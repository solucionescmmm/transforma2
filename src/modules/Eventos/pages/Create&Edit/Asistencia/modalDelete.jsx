...
const ModalDelete = ({ handleOpenDialog, open, refresh, values }) => {
    //===============================================================================================================================================
    //========================================== Context ============================================================================================
    //===============================================================================================================================================
            ...
            await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_EVENTOS_ASISTENCIA_DELETE}`,
                    data,
                    headers: {
                        token,
                    },
    ...
    useEffect(() => {
        if (values) {
            setData({
                ...
                intIdAsistenteEvento: values?.intId,
            });
        }
    ...
    //========================================== Renders ============================================================================================
    //===============================================================================================================================================
    if (!data.intIdAsistenteEvento && !data.intIdSesion) {
        return (
            <Dialog
    ...
    return (
        ...
        >
            ...
            <DialogTitle>{`¿Desea desmarcar la asistencia de la persona seleccionada?`}</DialogTitle>
