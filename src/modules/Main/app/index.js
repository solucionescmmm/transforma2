...
app.use(require("../../Diagnosticos/Diagnostico Empresarial/Diagnostico Competencias Tecnicas/infra/http/apiDiagnosticoTecnicas.routes"))
...
app.use(require("../../Eventos/infra/http/apiEventos.routes"))
