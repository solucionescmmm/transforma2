    ...
    return (
        <Fragment>
            ...
            <Grid container direction="row" spacing={2}>
                ...
                <Grid item xs={12}>
                    <Typography variant="h6">Gestión de paquetes</Typography>
                                ...
                                actions={[
                                    (rowData) => {
                                        return {
                                            ...
                                            onClick: (event, rowData) => {
                                                push(
                                                    `/transforma/admin/paquetes/edit/${rowData.objInfoPrincipal.intId}`
                                                );
                                            },
                                            disabled:
                                                rowData.objInfoPrincipal
                                    ...
                                    (rowData) => {
                                        return {
                                            ...
                                            onClick: (event, rowData) => {
                                                push(
                                                    `/transforma/admin/paquetes/preview/${rowData.objInfoPrincipal.intId}`
                                                );
                                            },
                                        };
                                    },
                                                ...
                                                <Grid item xs={12}>
                                                    ...
                                                    >
                                                        <Button
                                                            ...
                                                            onClick={() =>
                                                                push(
                                                                    "/transforma/admin/paquetes/create"
                                                                )
                                                            }
                                                        >
                                                            Agregar paquete
