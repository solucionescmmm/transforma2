    ...
    if (data === null) {
        return (
            ...
            >
                ...
                No existen datos por mostrar del servicio de proyectos especiales
            </Alert>
        );
    }
    ...
    if (data.error) {
        return (
            ...
            >
                ...
                Ha ocurrido un error al obtener los datos del listado de proyectos especiales
            </Alert>
        );
    }
...
export default SelectProyectoEs;
