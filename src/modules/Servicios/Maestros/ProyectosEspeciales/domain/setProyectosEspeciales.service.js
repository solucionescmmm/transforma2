...
class setProyectosEspeciales {
    ...
    async main() {
        ...
        this.#completeData();
        await this.#setProyectosEspeciales();
    ...
    async #setProyectosEspeciales() {
        let dao = new classInterfaceDAOProyectosEspeciales();

        let query = await dao.setProyectosEspeciales(this.#objData);
...
module.exports = setProyectosEspeciales;
