            ...
            for (let i = 0; i < array.length; i++) {
                ...
                let objInfoProductos= {
                  ...
                  let objInfoCategoria1= {
                    ...
                    strSostenibilidadDetalle: array[i]?.strSostenibilidadDetalle,
                    strSostenibilidadNivel: array[i]?.strSostenibilidadNivel,
                    strAtributosValor: array[i]?.strAtributosValor,
                    strAtributosValorDetalle: array[i]?.strAtributosValorDetalle,
                    ...
                    strMenajoTecnicaAlimDetalle: array[i]?.strMenajoTecnicaAlimDetalle,
                    strMenajoTecnicaAlimNivel: array[i]?.strMenajoTecnicaAlimNivel,
                    strProcesosPreparacion: array[i]?.strProcesosPreparacion,
                    strProcesosPreparacionDetalle: array[i]?.strProcesosPreparacionDetalle,
                    strProcesosPreparacionNivel: array[i]?.strProcesosPreparacionNivel,
                    strPresentacionApariencia: array[i]?.strPresentacionApariencia,
                    strPresentacionAparienciaDetalle: array[i]?.strPresentacionAparienciaDetalle,
                    strPresentacionAparienciaNivel: array[i]?.strPresentacionAparienciaNivel,
                    strProporcionAlim: array[i]?.strProporcionAlim,
                    strProporcionAlimDetalle: array[i]?.strProporcionAlimDetalle,
                    ...
                    strEmpaqueEtiquetaAlimDetalle: array[i]?.strEmpaqueEtiquetaAlimDetalle,
                    strEmpaqueEtiquetaAlimNivel: array[i]?.strEmpaqueEtiquetaAlimNivel,
                    ...
                    strAcabadosFacturaDetalle: array[i]?.strAcabadosFacturaDetalle,
                    ...
                    strEmpaqueEtiquetaDetalle: array[i]?.strEmpaqueEtiquetaDetalle,
                    ...
                    strDisenioExperienciaDetalle: array[i]?.strDisenioExperienciaDetalle,
                    strDisenioExperienciaNivel: array[i]?.strDisenioExperienciaNivel
                  }
