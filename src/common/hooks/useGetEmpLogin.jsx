 ...
 *
 */
const useGetLastEmpresarios = ({ autoLoad = true, strDocumento = null } = {}) => {
    //===============================================================================================================================================
            ...
            return await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_LOGIN_EMPRESARIOS_GET}`,
                    headers: {
                        token,
                    },
                    params: {
...
export default useGetLastEmpresarios;
