 ...
 *
 */
const useGetEmpresarioEvento = ({ autoLoad = true } = {}) => {
    //===============================================================================================================================================
            ...
            return await axios(
                {
                    ...
                    url: `${process.env.REACT_APP_API_TRANSFORMA_EMPRESARIOS_GET_EMPRESARIOEVENTO}`,
                    headers: {
                        token,
                    }
                },
...
export default useGetEmpresarioEvento;